"""
Django settings for mhouse project.
...
ALLOWED_HOSTS = ['web-production-e3a2.up.railway.app', '127.0.0.1']
...
CSRF_TRUSTED_ORIGINS = ['https://web-production-e3a2.up.railway.app']
